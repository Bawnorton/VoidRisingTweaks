...
public class  VRTBlockInit {
    ...
    public static final Hashtable<String, Block[]> TAINTED_BLOCKS = new Hashtable<String, Block[]>() {{
        put("tainted_andesite", new Block[]{SLIGHTLY_TAINTED_ANDESITE, PARTIALLY_TAINTED_ANDESITE, MOSTLY_TAINTED_ANDESITE, TAINTED_ANDESITE});
        put("tainted_clay", new Block[]{SLIGHTLY_TAINTED_CLAY, PARTIALLY_TAINTED_CLAY, MOSTLY_TAINTED_CLAY, TAINTED_CLAY});
        put("tainted_cobblestone", new Block[]{SLIGHTLY_TAINTED_COBBLESTONE, PARTIALLY_TAINTED_COBBLESTONE, MOSTLY_TAINTED_COBBLESTONE, TAINTED_COBBLESTONE});
        put("tainted_diorite", new Block[]{SLIGHTLY_TAINTED_DIORITE, PARTIALLY_TAINTED_DIORITE, MOSTLY_TAINTED_DIORITE, TAINTED_DIORITE});
        put("tainted_granite", new Block[]{SLIGHTLY_TAINTED_GRANITE, PARTIALLY_TAINTED_GRANITE, MOSTLY_TAINTED_GRANITE, TAINTED_GRANITE});
        put("tainted_gravel", new Block[]{SLIGHTLY_TAINTED_GRAVEL, PARTIALLY_TAINTED_GRAVEL, MOSTLY_TAINTED_GRAVEL, TAINTED_GRAVEL});
        put("tainted_sand", new Block[]{SLIGHTLY_TAINTED_SAND, PARTIALLY_TAINTED_SAND, MOSTLY_TAINTED_SAND, TAINTED_SAND});
        put("tainted_sandstone", new Block[]{SLIGHTLY_TAINTED_SANDSTONE, PARTIALLY_TAINTED_SANDSTONE, MOSTLY_TAINTED_SANDSTONE, TAINTED_SANDSTONE});
        put("tainted_stone_bricks", new Block[]{SLIGHTLY_TAINTED_STONE_BRICKS, PARTIALLY_TAINTED_STONE_BRICKS, MOSTLY_TAINTED_STONE_BRICKS, TAINTED_STONE_BRICKS});
        put("tainted_ore_bauxite", new Block[]{SLIGHTLY_TAINTED_ORE_BAUXITE, PARTIALLY_TAINTED_ORE_BAUXITE, MOSTLY_TAINTED_ORE_BAUXITE, TAINTED_ORE_BAUXITE});
        put("tainted_ore_boron", new Block[]{SLIGHTLY_TAINTED_ORE_BORON, PARTIALLY_TAINTED_ORE_BORON, MOSTLY_TAINTED_ORE_BORON, TAINTED_ORE_BORON});
        put("tainted_ore_copper", new Block[]{SLIGHTLY_TAINTED_ORE_COPPER, PARTIALLY_TAINTED_ORE_COPPER, MOSTLY_TAINTED_ORE_COPPER, TAINTED_ORE_COPPER});
        put("tainted_ore_galena", new Block[]{SLIGHTLY_TAINTED_ORE_GALENA, PARTIALLY_TAINTED_ORE_GALENA, MOSTLY_TAINTED_ORE_GALENA, TAINTED_ORE_GALENA});
        put("tainted_ore_gold", new Block[]{SLIGHTLY_TAINTED_ORE_GOLD, PARTIALLY_TAINTED_ORE_GOLD, MOSTLY_TAINTED_ORE_GOLD, TAINTED_ORE_GOLD});
        put("tainted_ore_iridium", new Block[]{SLIGHTLY_TAINTED_ORE_IRIDIUM, PARTIALLY_TAINTED_ORE_IRIDIUM, MOSTLY_TAINTED_ORE_IRIDIUM, TAINTED_ORE_IRIDIUM});
        put("tainted_ore_iron", new Block[]{SLIGHTLY_TAINTED_ORE_IRON, PARTIALLY_TAINTED_ORE_IRON, MOSTLY_TAINTED_ORE_IRON, TAINTED_ORE_IRON});
        put("tainted_ore_lead", new Block[]{SLIGHTLY_TAINTED_ORE_LEAD, PARTIALLY_TAINTED_ORE_LEAD, MOSTLY_TAINTED_ORE_LEAD, TAINTED_ORE_LEAD});
        put("tainted_ore_lithium", new Block[]{SLIGHTLY_TAINTED_ORE_LITHIUM, PARTIALLY_TAINTED_ORE_LITHIUM, MOSTLY_TAINTED_ORE_LITHIUM, TAINTED_ORE_LITHIUM});
        put("tainted_ore_nickel", new Block[]{SLIGHTLY_TAINTED_ORE_NICKEL, PARTIALLY_TAINTED_ORE_NICKEL, MOSTLY_TAINTED_ORE_NICKEL, TAINTED_ORE_NICKEL});
        put("tainted_ore_magnesium", new Block[]{SLIGHTLY_TAINTED_ORE_MAGNESIUM, PARTIALLY_TAINTED_ORE_MAGNESIUM, MOSTLY_TAINTED_ORE_MAGNESIUM, TAINTED_ORE_MAGNESIUM});
        put("tainted_ore_silver", new Block[]{SLIGHTLY_TAINTED_ORE_SILVER, PARTIALLY_TAINTED_ORE_SILVER, MOSTLY_TAINTED_ORE_SILVER, TAINTED_ORE_SILVER});
        put("tainted_ore_thorium", new Block[]{SLIGHTLY_TAINTED_ORE_THORIUM, PARTIALLY_TAINTED_ORE_THORIUM, MOSTLY_TAINTED_ORE_THORIUM, TAINTED_ORE_THORIUM});
        put("tainted_ore_tin", new Block[]{SLIGHTLY_TAINTED_ORE_TIN, PARTIALLY_TAINTED_ORE_TIN, MOSTLY_TAINTED_ORE_TIN, TAINTED_ORE_TIN});
        put("tainted_ore_uranium", new Block[]{SLIGHTLY_TAINTED_ORE_URANIUM, PARTIALLY_TAINTED_ORE_URANIUM, MOSTLY_TAINTED_ORE_URANIUM, TAINTED_ORE_URANIUM});
        put("tainted_ore_certus", new Block[]{SLIGHTLY_TAINTED_ORE_CERTUS, PARTIALLY_TAINTED_ORE_CERTUS, MOSTLY_TAINTED_ORE_CERTUS, TAINTED_ORE_CERTUS});
        put("tainted_ore_charged_certus", new Block[]{SLIGHTLY_TAINTED_ORE_CHARGED_CERTUS, PARTIALLY_TAINTED_ORE_CHARGED_CERTUS, MOSTLY_TAINTED_ORE_CHARGED_CERTUS, TAINTED_ORE_CHARGED_CERTUS});
        put("tainted_ore_coal", new Block[]{SLIGHTLY_TAINTED_ORE_COAL, PARTIALLY_TAINTED_ORE_COAL, MOSTLY_TAINTED_ORE_COAL, TAINTED_ORE_COAL});
        put("tainted_ore_diamond", new Block[]{SLIGHTLY_TAINTED_ORE_DIAMOND, PARTIALLY_TAINTED_ORE_DIAMOND, MOSTLY_TAINTED_ORE_DIAMOND, TAINTED_ORE_DIAMOND});
        put("tainted_ore_emerald", new Block[]{SLIGHTLY_TAINTED_ORE_EMERALD, PARTIALLY_TAINTED_ORE_EMERALD, MOSTLY_TAINTED_ORE_EMERALD, TAINTED_ORE_EMERALD});
        put("tainted_ore_lapis", new Block[]{SLIGHTLY_TAINTED_ORE_LAPIS, PARTIALLY_TAINTED_ORE_LAPIS, MOSTLY_TAINTED_ORE_LAPIS, TAINTED_ORE_LAPIS});
        put("tainted_ore_redstone", new Block[]{SLIGHTLY_TAINTED_ORE_REDSTONE, PARTIALLY_TAINTED_ORE_REDSTONE, MOSTLY_TAINTED_ORE_REDSTONE, TAINTED_ORE_REDSTONE});
        put("tainted_ore_ruby", new Block[]{SLIGHTLY_TAINTED_ORE_RUBY, PARTIALLY_TAINTED_ORE_RUBY, MOSTLY_TAINTED_ORE_RUBY, TAINTED_ORE_RUBY});
        put("tainted_ore_sapphire", new Block[]{SLIGHTLY_TAINTED_ORE_SAPPHIRE, PARTIALLY_TAINTED_ORE_SAPPHIRE, MOSTLY_TAINTED_ORE_SAPPHIRE, TAINTED_ORE_SAPPHIRE});
    }};
