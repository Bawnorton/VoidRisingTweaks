...
import thaumcraft.common.blocks.basic.BlockSlabTC.Double;
import thaumcraft.common.blocks.basic.BlockSlabTC.Half;
...
import thaumcraft.common.blocks.world.BlockLoot.LootType;
...
public class ConfigBlocks {
    ...
    public static void initBlocks(IForgeRegistry<Block> iForgeRegistry) {
        ...
        BlocksTC.stoneAncientRock = registerBlock((BlockTC)(new BlockStoneTC("stone_ancient_rock", false)).setHardness(-1.0F));
        BlocksTC.stoneAncientGlyphed = registerBlock(new BlockStoneTC("stone_ancient_glyphed", false));
        BlocksTC.stoneAncientDoorway = registerBlock((BlockTC)(new BlockStoneTC("stone_ancient_doorway", false)).setHardness(-1.0F));
        BlocksTC.stoneEldritchTile = registerBlock((BlockTC)(new BlockStoneTC("stone_eldritch_tile", true)).setHardness(15.0F).setResistance(1000.0F));
        ...
        BlocksTC.slabArcaneStone = (BlockSlab)(new Half("slab_arcane_stone", (Block)null, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.doubleSlabArcaneStone = (BlockSlab)(new Double("slab_double_arcane_stone", BlocksTC.slabArcaneStone, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.slabArcaneBrick = (BlockSlab)(new Half("slab_arcane_brick", (Block)null, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.doubleSlabArcaneBrick = (BlockSlab)(new Double("slab_double_arcane_brick", BlocksTC.slabArcaneBrick, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.slabAncient = (BlockSlab)(new Half("slab_ancient", (Block)null, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.doubleSlabAncient = (BlockSlab)(new Double("slab_double_ancient", BlocksTC.slabAncient, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.slabEldritch = (BlockSlab)(new Half("slab_eldritch", (Block)null, false)).setHardness(2.0F).setResistance(10.0F);
        BlocksTC.doubleSlabEldritch = (BlockSlab)(new Double("slab_double_eldritch", BlocksTC.slabEldritch, false)).setHardness(2.0F).setResistance(10.0F);
        ...
        BlocksTC.slabGreatwood = (BlockSlab)(new Half("slab_greatwood", (Block)null, true)).setHardness(1.2F).setResistance(2.0F);
        BlocksTC.doubleSlabGreatwood = (BlockSlab)(new Double("slab_double_greatwood", BlocksTC.slabGreatwood, true)).setHardness(1.2F).setResistance(2.0F);
        BlocksTC.slabSilverwood = (BlockSlab)(new Half("slab_silverwood", (Block)null, true)).setHardness(1.0F).setResistance(2.0F);
        BlocksTC.doubleSlabSilverwood = (BlockSlab)(new Double("slab_double_silverwood", BlocksTC.slabSilverwood, true)).setHardness(1.0F).setResistance(2.0F);
        ...
        BlocksTC.lootCrateCommon = registerBlock(new BlockLoot(Material.WOOD, "loot_crate_common", LootType.COMMON));
        BlocksTC.lootCrateUncommon = registerBlock(new BlockLoot(Material.WOOD, "loot_crate_uncommon", LootType.UNCOMMON));
        BlocksTC.lootCrateRare = registerBlock(new BlockLoot(Material.WOOD, "loot_crate_rare", LootType.RARE));
        BlocksTC.lootUrnCommon = registerBlock(new BlockLoot(Material.ROCK, "loot_urn_common", LootType.COMMON));
        BlocksTC.lootUrnUncommon = registerBlock(new BlockLoot(Material.ROCK, "loot_urn_uncommon", LootType.UNCOMMON));
        BlocksTC.lootUrnRare = registerBlock(new BlockLoot(Material.ROCK, "loot_urn_rare", LootType.RARE));
        ...
        for(var3 = 0; var3 < var2; ++var3) {
            dye = var1[var3];
            BlocksTC.candles.put(dye, registerBlock(new BlockCandle("candle_" + dye.getTranslationKey().toLowerCase(), dye)));
        }

        var1 = EnumDyeColor.values();
        var2 = var1.length;

        for(var3 = 0; var3 < var2; ++var3) {
            dye = var1[var3];
            BlockBannerTC block = new BlockBannerTC("banner_" + dye.getTranslationKey().toLowerCase(), dye);
        ...
        BlocksTC.bannerCrimsonCult = new BlockBannerTC("banner_crimson_cult", (EnumDyeColor)null);
        ...
        for(var3 = 0; var3 < var2; ++var3) {
            dye = var1[var3];
            BlocksTC.nitor.put(dye, registerBlock(new BlockNitor("nitor_" + dye.getTranslationKey().toLowerCase(), dye)));
        }
        ...
        BlocksTC.jarNormal = registerBlock(new BlockJar(TileJarFillable.class, "jar_normal"), (Class)BlockJarItem.class);
        BlocksTC.jarVoid = registerBlock(new BlockJar(TileJarFillableVoid.class, "jar_void"), (Class)BlockJarItem.class);
        BlocksTC.jarBrain = registerBlock(new BlockJar(TileJarBrain.class, "jar_brain"), (Class)BlockJarBrainItem.class);
        ...
        BlocksTC.mirror = registerBlock(new BlockMirror(TileMirror.class, "mirror"), (Class)BlockMirrorItem.class);
        BlocksTC.mirrorEssentia = registerBlock(new BlockMirror(TileMirrorEssentia.class, "mirror_essentia"), (Class)BlockMirrorItem.class);
        ...
        BlocksTC.activatorRail = registerBlock(((Block)(new BlockRailPowered()).setHardness(0.7F).setCreativeTab(ConfigItems.TABTC).setRegistryName("thaumcraft", "activator_rail")).setTranslationKey("activator_rail"));
        ...
        FluidRegistry.addBucketForFluid(ConfigBlocks.FluidDeath.instance);
        ...
        FluidRegistry.addBucketForFluid(ConfigBlocks.FluidPure.instance);
